    ...
    def info(self, msg: str) -> None:
        ...
        if msg.startswith(MATCHING_LOGIC_MSG) is True or \
           ...
           is True:
            ...
            elif event_name == "LMRequestUpdateEvent":
...
class SimulationLogger:
    ...
    def __init__(self, _: str,trace_file:str=""):
        """
        Initialise the object.
        ...
        """
        if SimulationLogger.is_setup is False:
            SimulationLogger.LOG_FILE_NAME =(SimulationLogger.LOG_FILE_PATH /
                                            trace_file)

            SimulationLogger.logger_obj = Logger(
                output_file_path=SimulationLogger.LOG_FILE_NAME)

            # Makes sure that the root logger is setup only once
            SimulationLogger.is_setup = True
    ...
    def get_logger(self) -> Logger:
        ...
        """
        assert SimulationLogger.logger_obj is not None
        return SimulationLogger.logger_obj
